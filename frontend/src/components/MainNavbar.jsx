...
const MainNavbar = ({ hideIcons = false }) => {
  ...
  return (
    <nav className={`bg-transparent text-gray-800 py-4 px-8 font-semibold shadow-sm transition duration-300`}>
      <div className="container mx-auto flex flex-wrap justify-between items-center relative">
        ...
        {!hideIcons && (
          <div className="flex lg:flex-row flex-col items-center space-x-4 mt-2 lg:mt-0">
            <IconButton 
